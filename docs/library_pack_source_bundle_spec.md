...
- The bounded live `general-en` slice on `2026-04-10` currently validates cleanly at `expected_recall=1.0` and `precision=1.0` with `entity_record_count=9`, `alias_count=206`, and `ambiguous_alias_count=0`.
