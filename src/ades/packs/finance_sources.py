...
DEFAULT_CURATED_FINANCE_ENTITIES: tuple[dict[str, object], ...] = (
    ...
    _curated_finance_entity(
        ...
        entity_id="ades:impact:environment:pollution-crisis",
        metadata={"category": "environmental_supply_risk"},
    ),
    _curated_finance_entity(
        "shipping_risk",
        ...
        aliases=(
            "oil tanker sanctions",
            "Russian-linked oil tanker sanctions",
        ...
        entity_id="ades:impact:shipping:tanker-sanctions",
        metadata={"category": "energy_shipping_sanctions"},
    ),
    _curated_finance_entity(
        "policy",
        ...
        entity_id="ades:impact:policy:digital-asset-regulation",
        metadata={"category": "digital_asset_regulation"},
    ),
    _curated_finance_entity(
        "commodity",
        "Wheat",
    ...
    _curated_finance_entity(
        "commodity",
        "Live cattle",
        aliases=("live cattle futures", "cattle futures"),
    ...
    _curated_finance_entity(
        "commodity",
        "Lean hogs",
        aliases=("lean hog futures", "hog futures"),
    ...
    _curated_finance_entity(
        ...
        "Bitcoin",
        aliases=("BTC",),
        entity_id="ades:impact:crypto:bitcoin",
        metadata={"category": "digital_asset"},
    ),
    _curated_finance_entity(
        "commodity",
        "COMEX gold",
