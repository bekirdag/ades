...
def create_noisy_general_generation_bundle(root: Path) -> Path:
    ...
    entities = [
        ...
        {
            "entity_id": "location:israel",
            "entity_type": "location",
            "canonical_text": "Israel",
            "aliases": [],
            "source_name": "curated-general",
            "population": 9_800_000,
        },
        {
            "entity_id": "location:shanghai",
            "entity_type": "location",
            "canonical_text": "Shanghai",
            "aliases": [],
            "source_name": "curated-general",
            "population": 24_000_000,
        },
        {
            "entity_id": "location:four",
            "entity_type": "location",
            "canonical_text": "Four",
            "aliases": [],
            "source_name": "curated-general",
        ...
        {
            "entity_id": "organization:northwind-solutions",
            "entity_type": "organization",
            "canonical_text": "Northwind Solutions",
            "aliases": [],
            "source_name": "curated-general",
            "popularity": 0.84,
        },
        {
            "entity_id": "organization:harbor-china-information",
            "entity_type": "organization",
            "canonical_text": "Harbor China Information",
            "aliases": ["Harbor"],
            "source_name": "curated-general",
            "popularity": 0.82,
        },
