...
from ades import build_medical_source_bundle, report_generated_pack
from tests.medical_bundle_helpers import create_medical_raw_snapshots


def test_public_api_can_report_generated_medical_pack_statistics(
    tmp_path: Path,
) -> None:
    ...
    assert report.label_distribution["clinical_trial"] == 3
