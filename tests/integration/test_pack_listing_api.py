...
from ades import list_available_packs, list_packs
from ades.storage import UnsupportedRuntimeConfigurationError


def test_public_pack_listing_rejects_missing_explicit_config(
...
def test_public_available_pack_listing_rejects_invalid_runtime_target(
    tmp_path: Path, monkeypatch
) -> None:
