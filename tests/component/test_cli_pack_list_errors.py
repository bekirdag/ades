...
def test_cli_packs_list_reports_missing_explicit_config(tmp_path: Path) -> None:
    runner = CliRunner()
...
def test_cli_list_packs_reports_invalid_runtime_target(tmp_path: Path) -> None:
    runner = CliRunner()
    ...
    result = runner.invoke(
        app,
        ["list", "packs", "--registry-url", "https://example.invalid/index.json"],
        env={
